...
Declare @Show_ID uniqueidentifier = '4120D67E-7799-4A1E-8241-A36A4D92C544'
...
inner join [WSuffolk_2024].[dbo].[lnkDog_Owners] do
on d.Dog_ID = do.Dog_ID
and do.Deleted_By is null
inner join [WSuffolk_2024].[dbo].[tblPeople] owners
on do.Owner_ID = owners.Person_ID
and owners.Deleted_By is null
inner join [WSuffolk_2024].[dbo].[tblEntrants] e
on dc.Entrant_ID = e.Entrant_ID
and e.Deleted_By is null
inner join [WSuffolk_2024].[dbo].[tblShow_Entry_Classes] sec
...
inner join [WSuffolk_2024].[dbo].[lkpClass_Names] cn
...
from [WSuffolk_2024].[dbo].[lnkLinked_Shows] ls
